...
if __name__ == "__main__":
    ...
    filenames = glob(os.path.join(parser_args.image_folder, "*.nii"))
    for filename in sorted(filenames):
        ...
        reoriented.Update()
        itk.imwrite(reoriented, os.path.join(parser_args.output_folder, basename_wo_ext + ".nii"))
        input("here")
